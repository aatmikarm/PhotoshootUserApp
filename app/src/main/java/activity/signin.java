...
public class signin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup = (Button) findViewById(R.id.signInbtn_signup);
        btnLogin = (Button) findViewById(R.id.signInbtn_login);
        btnReset = (Button) findViewById(R.id.signInbtn_reset_password);
