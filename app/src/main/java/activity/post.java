                ...
                if (clicked==true) {
                    ...
                    mDb.collection("posts/"+postDateandTime+"/likes/").document(currentUserUid).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(post.this, "like of currentUser was removed", Toast.LENGTH_SHORT).show();
                        }
                    });

                    mDb.collection("users/"+postUid+"/"+"post/").document(postDateandTime).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(post.this, "like of currentUser was removed", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    mDb.collection("users/"+postUid+"/"+"post/").document(postDateandTime).set(postDetails);
                    mDb.collection("posts/"+postDateandTime+"/likes/").document(currentUserUid).set(postDetails);
                    Toast.makeText(post.this, "like of currentUser was added", Toast.LENGTH_SHORT).show();
